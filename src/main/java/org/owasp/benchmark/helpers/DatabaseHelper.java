...
public class DatabaseHelper {
    ...
    // Static schema/procedure definitions executed once at class initialization. Each statement is
    // held in a single, non-concatenated compile-time constant so no runtime value can ever be
    // spliced into the SQL text handed to the JDBC statement executor.
    private static final String CREATE_VERIFY_USER_PASSWORD_PROC_SQL =
    ...
    private static final String CREATE_CERTIFICATE_TABLE_SQL =
    ...
    private static final String CREATE_VERIFY_EMPLOYEE_SALARY_PROC_SQL =
    ...
    public static void initDataBase() {
        try {
            ...
            executeSQLCommand(CREATE_VERIFY_USER_PASSWORD_PROC_SQL);

            executeSQLCommand(CREATE_EMPLOYEE_TABLE_SQL);

            executeSQLCommand(CREATE_CERTIFICATE_TABLE_SQL);

            executeSQLCommand(CREATE_VERIFY_EMPLOYEE_SALARY_PROC_SQL);
            conn.commit();
            initData();
